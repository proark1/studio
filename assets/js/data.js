...
NFT Gym Team`,
    ...
    valueLevers:[
      {rank:1, name:"90-Tage-Erfolgsreise", user:"Eltern, Kinder, Trainer", value:"Aus Probetraining wird Routine", status:"live", kpi:"8 Check-ins im 1. Monat", route:"#/app/onboarding"},
      {rank:2, name:"Mitarbeiter-Cockpit", user:"Rezeption, Standortleitung", value:"Heute zuerst statt Chaos", status:"live", kpi:"SLA-Verstoesse runter", route:"#/crm/dashboard"},
      {rank:3, name:"Wochenfortschritt", user:"Eltern, Trainer", value:"Eltern sehen, wofuer sie zahlen", status:"live", kpi:"Report-Quote 80 %+", route:"#/trainer/reports"},
      {rank:4, name:"Kunden-360 + HITL-Inbox", user:"Support, Sales, Trainer", value:"Jede Anfrage in Sekunden verstehen", status:"live", kpi:"Antwortzeit < 1 Std", route:"#/crm/support"},
      {rank:5, name:"Selfservice-Center", user:"Eltern, Rezeption", value:"Standardfaelle ohne Mitarbeiter", status:"live", kpi:"70 % Selfservice", route:"#/app/konto"},
      {rank:6, name:"Arbeitszeit, Dienstplan, Quali", user:"Mitarbeiter, GF", value:"Fair, gesetzeskonform, skalierbar", status:"live", kpi:"0 Kinderkurse ohne Quali", route:"#/crm/zeiten"},
      {rank:7, name:"Sicherheit & Unfallprozess", user:"Kinder, Eltern, Trainer", value:"Vertrauen im sensibelsten Moment", status:"neu", kpi:"Elternkontakt < 30 Min", route:"#/crm/sicherheit"},
      {rank:8, name:"NFT Puls", user:"Kunden, Team, GF", value:"Feedback wird Handlung", status:"live", kpi:"Detraktor-SLA 24h", route:"#/crm/feedback"},
      {rank:9, name:"Trainer-Curriculum", user:"Trainer, Kinder, GF", value:"Gleiche Qualitaet je Standort", status:"neu", kpi:"Prep-Zeit < 10 Min", route:"#/crm/curriculum"},
      {rank:10, name:"Community & Zusatzwert", user:"Familien, GF, Standort", value:"Mehr Bindung plus Nebenumsatz", status:"live", kpi:"+3-5 % ARPU", route:"#/events"},
    ],
    ninetyDays:[
      {day:"Tag 0", title:"Probetraining bestanden", owner:"Rezeption", done:true, metric:"Vertrag + App aktiv"},
      {day:"Tag 1-3", title:"Erstes Mitglieds-Training", owner:"Trainer", done:true, metric:"Buddy begruesst Kind"},
      {day:"Tag 7", title:"Mini-Check-in Eltern", owner:"System + Mensch", done:false, cur:true, metric:"Unsicherheit abfangen"},
      {day:"Tag 14", title:"2. Trainingswoche stabilisieren", owner:"Trainer", done:false, metric:"2 Einheiten/Woche"},
      {day:"Tag 30", title:"8-Check-ins-Ziel", owner:"Standortleitung", done:false, metric:">=8 Check-ins"},
      {day:"Tag 60", title:"Fortschrittsgespraech light", owner:"Trainer", done:false, metric:"naechstes Guertelziel"},
      {day:"Tag 90", title:"Retention-Moment", owner:"System", done:false, metric:"NPS + Referral-Weiche"},
    ],
    safety:{
      coverage:{ firstAid:"100 %", contacts:"98 %", openIncidents:1, avgParentContact:"18 Min" },
      incidents:[
        {id:"I1", when:"heute 16:28", child:"Emir A.", loc:"Krefeld", type:"leichter Sturz", status:"Follow-up offen",
          steps:["Erste Hilfe durch Mehmet dokumentiert","Mutter Nicole um 16:41 telefonisch erreicht","Foto/Video nicht betroffen","Follow-up morgen 10:00 faellig"]},
        {id:"I2", when:"gestern", child:"Sara A.", loc:"Krefeld", type:"Unwohlsein", status:"geschlossen",
          steps:["Training abgebrochen","Abholperson informiert","72h-Follow-up erledigt"]},
      ],
      checks:[
        {name:"Erste-Hilfe-Abdeckung je Schicht", status:"ok", note:"Heute alle Kids-Kurse abgedeckt"},
        {name:"Notfallkontakte je Kind", status:"warn", note:"2 Profile ohne zweite Kontaktperson"},
        {name:"Unfallprotokoll-Vollstaendigkeit", status:"ok", note:"100 % Pflichtfelder"},
        {name:"Kinderschutz-Playbook", status:"ok", note:"GF-Eskalation definiert"},
      ],
      playbooks:[
        {name:"Unfall im Kurs", owner:"Trainer -> Standortleitung", sla:"Elternkontakt < 30 Min"},
        {name:"Kinderschutz-Hinweis", owner:"Standortleitung -> GF", sla:"sofort, immer manuell"},
        {name:"Standortschliessung", owner:"GF", sla:"Push + WhatsApp-Vorlage < 15 Min"},
      ],
    },
    curriculum:{
      stats:{ modules:38, ageBands:5, readyPlans:124, avgPrep:"7 Min" },
      today:{
        course:"Kids Kickboxen 6-9", belt:"Gelbgurt", goal:"Deckung nach Jab-Cross stabilisieren",
        blocks:[
          ["Warm-up", "Mattenregeln + Reaktionsspiel", "8 Min"],
          ["Technik", "Jab-Cross, Rueckhand bleibt oben", "12 Min"],
          ["Partnerdrill", "Coach zaehlt, Kind blockt und kontert", "15 Min"],
          ["Spiel", "Schattenboxen-Staffel ohne Kontakt", "8 Min"],
          ["Abschluss", "1 Lob + 1 naechster Fokus je Kind", "5 Min"],
        ],
        safety:"Kein freies Sparring. Fokus auf Abstand, Blickkontakt und kontrollierte Trefferflaeche.",
      },
      tracks:[
        {name:"Mini 3-5", modules:8, next:"Koordination + Regeln", quality:"4,7/5"},
        {name:"Kids 6-9 Kickboxen", modules:12, next:"Gelbgurt Woche 4", quality:"4,6/5"},
        {name:"Kids BJJ 10-14", modules:10, next:"Guard-Escapes", quality:"4,5/5"},
        {name:"Teens", modules:8, next:"Selbstverteidigung Alltag", quality:"4,4/5"},
      ],
      onboarding:[
        {step:"Shadowing", text:"2 Stunden mit Head-Coach mitlaufen", done:true},
        {step:"Gefuehrte Stunde", text:"Stundenbild aus Curriculum halten", done:true},
        {step:"Feedback-Review", text:"Puls + Trainer-Feedback auswerten", done:false},
        {step:"Freigabe Kids-Kurs", text:"Quali-Register + Praxischeck", done:false},
      ],
    },
    journeys:[
    ...
    support:{
      ...
      items:[
        ...
        { id:"S7", ch:"email", who:"Marco S. (Mitglied)", topic:"Frage zum Vertrag", time:"vor 40 Min",
          msgs:[["in","Hallo, wie lange läuft mein MMA-Unlimited-Vertrag noch und kann ich ihn pausieren?"]],
          ai:"Hallo Herr S.,\n\nIhr MMA-Unlimited-Vertrag läuft mit 24 Monaten Erstlaufzeit, danach monatlich kündbar. Eine Pausierung (1–3 Monate) ist jederzeit möglich. Soll ich Ihnen die Pausierung direkt einrichten?\n\nViele Grüße\nNFT Gym Köln",
          status:"freigabe", note:"Bestandskunde · Vertragsfrage (kein sensibler Fall) → KI-Entwurf wartet auf Freigabe" },
        { id:"S8", ch:"web", who:"Sandra W.", topic:"Probetraining Frauen-Kurs", time:"vor 1 Std",
          msgs:[["in","Hallo, ich interessiere mich für den Frauen-Kurs in Hilden. Wann kann ich zum Probetraining kommen?"]],
          ai:"Hallo Frau W.,\n\nunser Frauen-Kurs in Hilden ist ideal zum Einstieg. Nächster freier Termin: Donnerstag 19:00. Soll ich Sie für ein kostenloses Probetraining eintragen?\n\nViele Grüße\nNFT Gym Hilden",
          status:"freigabe", note:"Website-Anfrage → KI-Entwurf mit Terminvorschlag wartet auf Freigabe" },
      ],
    },
    tasks:[
