...
window.DATA = {
  ...
  kids: [
    { name:"Emir", age:7, program:"Kids Kickboxen 6–9", belt:"Gelbgurt", beltColor:"#f5c518", trainer:"Mehmet",
      ...
      badges:[ {i:"🔥",n:"5-Wochen-Serie",got:true},{i:"🥋",n:"10 Trainings",got:true},{i:"👊",n:"Erste Falltechnik",got:true},{i:"⭐",n:"5 Stripes",got:true},{i:"🤼",n:"Erstes Sparring",got:false},{i:"🎖️",n:"Prüfung bestanden",got:false} ] },
  ...
  crm:{
    kpis:[
      ...
      {n:27,l:"Offene Zahlungen",v:"red",go:"#/crm/zahlungen"},
      {n:5,l:"Rücklastschriften",v:"red",go:"#/crm/zahlungen"},
      {n:18,l:"Neue Leads",v:"",go:"#/crm/leads"},
      {n:3,l:"Überfüllte Kurse",v:"amber",go:"#/crm/kurse"},
      {n:34,l:"Inaktive Mitglieder",v:"amber",go:"#/crm/mitglieder"},
      {n:8,l:"Offene Verträge",v:"",go:"#/crm/vertraege"},
      {n:13,l:"KI-Entwürfe prüfen",v:"green",go:"#/crm/kommunikation"},
    ],
    pipeline:["Neu","Kontaktiert","Probe gebucht","Erschienen","Angebot","Vertrag"],
    leads:[
      {id:"L1",name:"Nicole A.",who:"Kind (Emir, 7)",loc:"Krefeld",interest:"Kickboxen",stage:"Neu",action:"KI-Mail senden"},
      {id:"L2",name:"Marco S.",who:"Erwachsen (32)",loc:"Köln",interest:"MMA",stage:"Probe gebucht",action:"Reminder"},
      {id:"L3",name:"Aylin K.",who:"Teen (15)",loc:"Meerbusch",interest:"Boxen",stage:"Angebot",action:"Nachfassen"},
      {id:"L4",name:"Familie Yildiz",who:"2 Kinder",loc:"Krefeld",interest:"Kids BJJ",stage:"Kontaktiert",action:"Anrufen"},
      {id:"L5",name:"Jonas P.",who:"Erwachsen (28)",loc:"Bochum",interest:"Ringen",stage:"Erschienen",action:"Vertrag vorbereiten"},
      {id:"L6",name:"Lea M.",who:"Kind (6)",loc:"München",interest:"Kids Kickboxen",stage:"Neu",action:"KI-Mail senden"},
      {id:"L7",name:"Deniz T.",who:"Teen (16)",loc:"Köln",interest:"MMA",stage:"Vertrag",action:"Unterschrift"},
      {id:"L8",name:"Sandra W.",who:"Erwachsen (35)",loc:"Hilden",interest:"Frauen-Kurs",stage:"Kontaktiert",action:"Termin anbieten"},
    ],
...
NFT Gym Team`,
    ...
    paysummary:{offen:27,rueck:5,heute:14,ok:231,recovery:"87 %",betrag:"429,60 €"},
    reports:{
      standorte:[
